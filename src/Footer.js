  ...
  <Layout.Footer style={{ backgroundColor: '#cecfcf', height: 200 }}>
    <Row>
      ...
      <Col span={6}>
        ...
        <FooterList>
          <FooterItemLink href="https://www.biogen.com">Biogen</FooterItemLink>
          <FooterItemLink href="http://www.ebi.ac.uk">EMBL-EBI</FooterItemLink>
          <FooterItemLink href="http://www.gsk.com">GSK</FooterItemLink>
          <FooterItemLink href="https://www.takeda.com">Takeda</FooterItemLink>
      ...
      <Col span={6}>
        ...
        <FooterList>
          <FooterIcon
            ...
            type="facebook"
          />
          <FooterIcon href="http://twitter.com/targetvalidate" type="twitter" />
          <FooterIcon
          ...
          <FooterIcon
            ...
            type="youtube"
          />
          <FooterIcon href="https://medium.com/opentargets" type="medium" />
          <FooterIcon href="https://github.com/opentargets" type="github" />
        </FooterList>
      </Col>
    </Row>
  </Layout.Footer>
