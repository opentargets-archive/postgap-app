...
class Detail extends React.Component {
  ...
  render() {
    const { clickedId, clickedType, clickedEntity, setClicked } = this.props;
    ...
    return <Tag {...{ [clickedType]: clickedEntity, closeHandler }} />;
  }
}

let DetailPanel = ({ clickedId, clickedType, clickedEntity, setClicked }) => {
  let detail = null;
  if (clickedType && clickedEntity) {
    // dynamically generate component
    detail = (
      <Detail {...{ clickedId, clickedType, clickedEntity, setClicked }} />
    );
  }
