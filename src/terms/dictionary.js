...
const DICTIONARY = {
  ...
  vep:
    'The Variant Effect Predictor (VEP) score is the functional consequence of the variant, e.g. missense, transcript ablation, mapped to a numeric value. It can be 0, 1, 2, 3, or 4.',
  gtex:
