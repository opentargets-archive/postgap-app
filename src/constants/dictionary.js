...
const DICTIONARY = {
    ...
    otg2vmusthave:
        'You can filter for the presence of significant VEP, GTEx, PCHiC, DHS, Fantom5 and Nearest gene-to-variant subscores. When multiple filters are applied, ALL must be true for an association to be returned.',
    vep:
